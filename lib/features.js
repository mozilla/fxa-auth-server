...
module.exports = config => {
  ...
  const ipProfilingEnabled = config.securityHistory && config.securityHistory.enabled
    && config.securityHistory.ipProfiling.enabled
  ...
  return {
    ...
    canBypassSiginConfirmation(verified, recency, events, request) {
      let bypass = false
