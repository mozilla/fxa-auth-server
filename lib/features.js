...
module.exports = config => {
  ...
  const devicesCache = config.devicesCache
  ...
  return {
    ...
    /**
     * Predicate that indicates whether devices cache is
     * enabled for a given user, based on their uid.
     *
     * @param uid   Buffer or String
     */
    isDevicesCacheEnabledForUser (uid) {
      return devicesCache.enabled &&
        isSampledUser(devicesCache.sampleRate, uid, 'devicesCache')
    },
    /**
