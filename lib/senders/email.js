...
module.exports = function (log, config) {
  ...
  Mailer.prototype.selectEmailServices = function (message) {
        ...
        return emailAddresses.reduce((services, emailAddress) => {
          if (liveConfig) {
            ...
            if (sendgrid && isLiveConfigMatch(sendgrid, emailAddress)) {
              return upsertExternalSendgrid(services, emailAddress)
            }

            if (ses && isLiveConfigMatch(ses, emailAddress)) {
              return upsertExternalSes(services, emailAddress)
            }
          }
          ...
          return upsertInternal(services, emailAddress)
        }, [])
      })
    ...
    function upsertExternalSendgrid (services, emailAddress) {
      return upsertService(services, SERVICES.externalSendgrid, emailAddress, {
    ...
    function upsertExternalSes (services, emailAddress) {
      return upsertService(services, SERVICES.externalSes, emailAddress, {
        mailer: mailers.external,
        emailService: 'fxa-email-service',
        emailSender: 'ses'
      })
    ...
    function upsertInternal (services, emailAddress) {
      return upsertService(services, SERVICES.internal, emailAddress, {
    ...
    function upsertService (services, service, emailAddress, data) {
