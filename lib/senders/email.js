...
module.exports = function (log) {
  ...
  var templateNameToCampaignMap = {
    ...
    'postVerifySecondaryEmail': 'account-verified',
  ...
  var templateNameToContentMap = {
    ...
    'postVerifySecondaryEmail': 'connect-device',
  ...
  function Mailer(translator, templates, config, sender) {
    ...
    this.androidAjustUrl = config.androidAdjustUrl
  ...
  Mailer.prototype.postVerifyEmail = function (message) {
    ...
    return this.send({
      ...
      templateValues: {
        link: links.link,
        installFireFox: links.installFirefox,
        privacyUrl: links.privacyUrl,
        supportUrl: links.supportUrl,
        supportLinkAttributes: links.supportLinkAttributes
      },
  ...
  Mailer.prototype.postVerifySecondaryEmail = function (message) {
    ...
    return this.send({
      ...
      template: templateName,
      templateValues: {
        androidAdjustUrl: links.androidAdjustUrl,
        iosAdjustUrl: links.iosAdjustUrl,
        link: links.link,
        privacyUrl: links.privacyUrl,
        supportUrl: links.supportUrl,
  ...
  Mailer.prototype._generateLinks = function (primaryLink, email, query, templateName) {
    ...
    links['iosAdjustUrl'] = this.iosAdjustUrl
    links['androidAdjustUrl'] = this.androidAjustUrl
