  ...
  .then(function (senders) {
    ...
    senders.email = {
      ...
      sendVerifyLoginEmail: function (account, code, opts) {
        var mailerPromises = account.emails.map(function (emailRecord) {
          if (emailRecord.isPrimary || emailRecord.isVerified) {
            return getSafeMailer(emailRecord.email)
              .then(function (mailer) {
        ...
        return P.all(mailerPromises)
      },
      sendVerifySecondaryEmail: function (account, code, opts) {
        return getSafeMailer(account.email)
          .then(function (mailer) {
      ...
      sendPasswordChangedNotification: function (emails, opts) {
        var mailerPromises = emails.map(function (emailRecord) {
          if (emailRecord.isPrimary || emailRecord.isVerified) {
            return getSafeMailer(emailRecord.email)
              .then(function (mailer) {
      ...
      sendPasswordResetNotification: function (emails, opts) {
        var mailerPromises = emails.map(function(emailRecord) {
          if (emailRecord.isPrimary || emailRecord.isVerified) {
            return getSafeMailer(emailRecord.email)
              .then(function (mailer) {
      ...
      sendNewDeviceLoginNotification: function (emails, opts) {
        var mailerPromises = emails.map(function (emailRecord) {
          if (emailRecord.isPrimary || emailRecord.isVerified) {
            return getSafeMailer(emailRecord.email)
              .then(function (mailer) {
      ...
      sendPostVerifySecondaryEmail: function (email, opts) {
        return getSafeMailer(email)
          .then(function (mailer) {
