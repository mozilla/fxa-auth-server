...
module.exports = function (log, config, error, db, translator, sender) {
  ...
  .then(function (senders) {
    ...
    function getVerifiedSecondaryEmails(emailData) {
      return emailData.reduce(function(list, email) {
    ...
    function getSecondaryEmails(emailData) {
      return emailData.reduce(function(list, email) {
        if (! email.isPrimary) {
          list.push(email.email)
        }
    ...
    senders.email = {
      sendVerifyCode: function (emailData, account, opts) {
      ...
      sendVerifyLoginEmail: function (emailData, account, opts) {
        var primaryEmail = account.email
        var ccEmails = getVerifiedSecondaryEmails(emailData)
      ...
      sendVerifySecondaryEmail: function (emailData, account, opts) {
        var primaryEmail = account.email
        var verifyEmailAddress = emailData[0].email
      ...
      sendRecoveryCode: function (emailData, account, opts) {
        var primaryEmail = account.email
        var ccEmails = getVerifiedSecondaryEmails(emailData)
      ...
      sendPasswordChangedNotification: function (emailData, account, opts) {
        var primaryEmail = account.email
        var ccEmails = getSecondaryEmails(emailData)
      ...
      sendPasswordResetNotification: function (emailData, account, opts) {
        var primaryEmail = account.email
        var ccEmails = getSecondaryEmails(emailData)
      ...
      sendNewDeviceLoginNotification: function (emailData, account, opts) {
        var primaryEmail = account.email
        var ccEmails = getSecondaryEmails(emailData)
      ...
      sendPostVerifyEmail: function (emailData, account, opts) {
        var primaryEmail = account.email
      ...
      sendPostVerifySecondaryEmail: function (emailData, account, opts) {
        var primaryEmail = account.email
      ...
      sendUnblockCode: function (emailData, account, opts) {
        var primaryEmail = account.email
        var ccEmails = getVerifiedSecondaryEmails(emailData)
