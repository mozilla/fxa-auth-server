...
module.exports = function (config, log) {
  ...
  .then(
    function (mailer) {
      ...
      mailer.sendPasswordResetRequiredNotification = function (email, opts) {
        return P.resolve(mailer.passwordResetRequiredEmail(
          {
            email: email,
            acceptLanguage: opts.acceptLanguage || defaultLanguage
          }
      ...
      mailer.sendSuspiciousLocationsEmail = function (email, locations, opts) {
        return P.resolve(mailer.postVerifyEmail(
          {
            email: email,
            acceptLanguage: opts.acceptLanguage || defaultLanguage,
