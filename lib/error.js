...
AppError.cannotAddEmailEqualToPrimary = () => {
  return new AppError({
    code: 400,
    error: 'Bad Request',
    errno: ERRNO.EMAIL_PRIMARY_EXISTS,
    message: 'Can not add secondary email that is same as primary'
  })
}
