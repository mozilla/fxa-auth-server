...
var ERRNO = {
  ...
  // XXX TODO: what happened to 163, is it up for grabs?
  STALE_AUTH_AT: 164,
  INCORRECT_REDIRECT_URI: 165,
  INVALID_RESPONSE_TYPE: 166,
  INVALID_SCOPES: 167,
  INCORRECT_PUBLIC_CLIENT: 168,
...
AppError.notPublicClient = (clientId) => {
  return new AppError({
    code: 400,
    error: 'Bad Request',
    errno: ERRNO.INCORRECT_PUBLIC_CLIENT,
