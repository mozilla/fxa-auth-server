...
const PUSH_NOTIFICATION_DELAY = 5000
      ...
      handler: function (request, reply) {
        ...
        function notifyAccount() {
          if (devicesToNotify) {
            ...
            // We deliberately introduce a small delay so that, if you're changing
            // your password from a connected device, it will receive the WebChannel
            // message from front-end web content before it receives the push
            // notification from us.
            P.delay(PUSH_NOTIFICATION_DELAY).then(() => push.notifyPasswordChanged(passwordChangeToken.uid, devicesToNotify))
          }
