  ...
  const routes = [
    {
      ...
      handler: async function (request, h) {
       ...
       try {
           ...
           await setMetricsFlowCompleteSignal()
    ...
    },
    {
      ...
      handler: async function (request, h) {
        ...
        await request.validateMetricsContext()
    ...
    },
    {
      ...
      handler: async function (request, h) {
        var sessionToken = await request.auth.credentials
        if (sessionToken) {
          ...
          return error.missingRequestParameter('uid')
        }
      }
    },
    {
      ...
      handler: async function (request, h) {
        ...
        try {
          const exist = await db.accountExists.bind(db, email)
          return {exists: exist}
        } catch (err){
          if (err.errno === error.ERRNO.ACCOUNT_UNKNOWN) {
            return { exists: false }
    ...
    },
    {
      ...
      handler: async function accountKeys(request, h) {
        ...
        if (! verified) {
          ...
          return error.unverifiedAccount()
        }
    ...
    },
    {
      ...
      handler: async function accountReset(request, h) {
    ...
    },
    {
      ...
      handler: async function accountDestroy(request, h) {
