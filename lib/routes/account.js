  ...
  var routes = [
    ...
    },
    {
      ...
      handler: function (request, reply) {
        ...
        var isEmailVerification = false, account
        ...
        db.account(uid)
          ...
          .then(() => {
            // Check to see if code being verified belongs to an email in the emails table.
            return db.verifyEmail(account, code)
              .then(() => {
                isEmailVerification = true
              })
              .catch(() => {
                // TODO Add better error code handling, for now just continue
                return true
              })
          })
          .then(
