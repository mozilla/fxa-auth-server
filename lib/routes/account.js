  ...
  var routes = [
    {
      ...
      handler: function accountCreate(request, reply) {
        ...
        function createSessionToken () {
          ...
          // Create a verified session if preVerified flag set or sign-in confirmation disabled
          var tokenVerifiedId = (preVerified || !doSigninConfirmation) ? undefined : tokenVerificationId
          ...
          return db.createSessionToken({
              ...
              tokenVerificationId: tokenVerifiedId
            }, userAgentString)
            .then(
              function (result) {
                sessionToken = result
    ...
    },
    {
      ...
      handler: function (request, reply) {
        ...
        var doSigninConfirmation = requestHelper.shouldEnableSigninConfirmation(sessionToken, config, request)

        // Choose which type of email to send
        var code, func
        if (!sessionToken.emailVerified || !doSigninConfirmation) {
