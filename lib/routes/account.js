...
module.exports = function (
  ...
  const ipProfilingEnabled = securityHistoryEnabled && config.securityHistory.ipProfiling.enabled
    ...
    },
    {
      ...
      handler: function (request, reply) {
        ...
        let emailRecord, sessions, sessionToken, keyFetchToken, mustVerifySession, doSigninConfirmation,
          emailSent, unblockCode, customsErr, allowSigninUnblock, didSigninUnblock, tokenVerificationId, hasVerifiedSessionFromIp
            ...
            .then(
              function (events) {
                ...
                if (events.length > 0) {
                  ...
                  // IP Profiling sets a flag to bypass sign-in confirmation if this
                  // user has verified a session with-in the past day from this ip address.
                  if (ipProfilingEnabled && verified && recency === 'day') {
                    hasVerifiedSessionFromIp = true
                    ...
                    hasVerifiedSessionFromIp = false
                  }
                }
              },
              function (err) {
        ...
        function checkEmailAndPassword () {
          ...
          //  * the login is coming from an ip address not previously seen.
