        ...
        function createSessionToken () {
          return db.createSessionToken({
            ...
            .then(
              function (result) {
                sessionToken = result
                return metricsContext.save(sessionToken, [
                  'device.created',
                  'account.verified',
                  'account.signed'
                ], form.metricsContext)
          ...
          return password.unwrap(account.wrapWrapKb)
            ...
            .then(
              function (keyFetchToken) {
                ...
                return metricsContext.save(keyFetchToken, 'account.keyfetch', form.metricsContext)
              }
            )
            .then(
              function () {
    ...
    },
    {
      ...
      handler: function accountKeys(request, reply) {
        ...
        db.deleteKeyFetchToken(keyFetchToken)
          ...
          .then(
            function () {
              return metricsContext.remove(keyFetchToken, 'account.keyfetch')
            }
          )
          .then(
            function () {
      ...
      handler: function (request, reply) {
        ...
        function upsertDevice () {
          ...
          return db[operation](sessionToken.uid, sessionToken.tokenId, payload)
            ...
            .then(
              function () {
                return metricsContext.remove(sessionToken, event)
              }
            )
            .then(
              function () {
            ...
            return db.createKeyFetchToken({
              ...
              .then(
                function (result) {
                  ...
                  return metricsContext.save(keyFetchToken, 'account.keyfetch', request.payload.metricsContext)
                }
              )
          }
        }
