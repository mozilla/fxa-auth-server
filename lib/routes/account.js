  ...
  var routes = [
    ...
    },
    {
      ...
      handler: function (request, reply) {
        ...
        let securityEvents, securityEventRecency, securityEventVerified = false
        ...
        function checkEmailAndPassword () {
          ...
          // Check to see if this login can be bypassed. Current scenario includes
          //  * User has already logged in from this ip address and verified the sign-in
          let bypassSiginConfirmation = features.canBypassSiginConfirmation(securityEventVerified, securityEventRecency, securityEvents, request)
