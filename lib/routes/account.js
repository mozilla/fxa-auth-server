          ...
          return db.emailRecord(email)
            .then(
              function (result) {
                ...
                // Check to see if the correct email case was used and don't explicitly
                // flag as an incorrect password attempt because the case was not
                // the same as what they used to sign-up with.
