...
module.exports = function (
  ...
  var routes = [
        ...
        function createSessionToken () {
          return db.createSessionToken({
            ...
            .then(
              function (result) {
                sessionToken = result
                return metricsContext.save(sessionToken, form.metricsContext)
              }
            )
        }
          ...
          return password.unwrap(account.wrapWrapKb)
            ...
            .then(
              function (keyFetchToken) {
                ...
                return metricsContext.save(keyFetchToken, form.metricsContext)
              }
            )
            .then(
              function () {
    ...
    },
    {
      ...
      handler: function accountKeys(request, reply) {
        ...
        db.deleteKeyFetchToken(keyFetchToken)
          ...
          .then(
            function () {
              return metricsContext.remove(keyFetchToken)
            }
          )
          .then(
            function () {
    ...
    },
    {
      ...
      handler: function (request, reply) {
        ...
        upsertDevice(request, sessionToken.uid, sessionToken.tokenId, payload)
          .then(
            function (device) {
    ...
    },
    {
      ...
      handler: function (request, reply) {
        ...
        return push.notifyDeviceDisconnected(uid, id)
          ...
          .then(
            function () {
              return metricsContext.remove(sessionToken)
            }
          )
          .then(function () {
            return result
          ...
          if (hasSessionToken) {
            ...
            return db.createSessionToken(sessionTokenOptions, request.headers['user-agent'])
              .then(
                function (result) {
                  sessionToken = result
                  return metricsContext.save(sessionToken, request.payload.metricsContext)
                }
              )
          }
        }
            ...
            return db.createKeyFetchToken({
              ...
              .then(
                function (result) {
                  ...
                  return metricsContext.save(keyFetchToken, request.payload.metricsContext)
                }
              )
          }
        }
  ...
  function upsertDevice (request, uid, sessionTokenId, device) {
    var operation, eventSuffix, result
    if (device.id) {
    ...
    return db[operation](uid, sessionTokenId, device)
      .then(
        function (res) {
          result = res
          return log.activityEvent('device.' + eventSuffix, request, {
            uid: uid.toString('hex'),
