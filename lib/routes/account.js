    ...
    },
    {
      ...
      handler: function (request, reply) {
        ...
        function checkEmailAndPassword () {
          ...
          var forceSigninConfirmation = false
          if (signinConfirmation.forcedEmailAddresses) {
            if (signinConfirmation.forcedEmailAddresses.test(emailRecord.email)) {
              forceSigninConfirmation = true
            }
          }

          if (! forceSigninConfirmation) {
