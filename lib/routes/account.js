...
function sanitizeAlphaNum(value) {
  return value && value.replace && value.replace(/[^a-zA-Z0-9-]/g, '')
}
  ...
  var routes = [
    {
      ...
      handler: function accountCreate(request, reply) {
        ...
        var service = sanitizeAlphaNum(form.service || query.service)
    ...
    },
    {
      ...
      handler: function (request, reply) {
        ...
        const service = sanitizeAlphaNum(request.payload.service || request.query.service)
