  ...
  var routes = [
                ...
                .then(function () {
                  ...
                  return db.verifyTokens(code, account)
                    ...
                    .then(function () {
                      ...
                      return db.verifyEmail(account, account.emailCode) // TODO Replace with actual emailCode
                        .then(function () {
    ...
    },
    {
      ...
      config: {
        validate: {
          query: {
            uid: isA.string().max(32).regex(HEX_STRING).required() // TODO We should be pulling this from the authenticated user
          }
        },
        response: {
      ...
      handler: function (request, reply) {
        const uidHex = request.query.uid
        var emails

        log.begin('Account.RecoveryEmailEmail', request)

        customs.check(request, uidHex, 'accountEmails') // TODO Replace with actual custom server logic
    ...
    },
    {
      ...
      handler: function (request, reply) {
        ...
        customs.check(request, uidHex, 'createEmail') // TODO Replace with actual custom server logic
          .then(generateRandomValues)
          .then(createEmail)
          .done(reply, reply)
        ...
        function createEmail() {
          ...
          return db.createEmail(emailData)
        }
      }
    },
    {
      ...
      handler: function (request, reply) {
        ...
        customs.check(request, uidHex, 'deleteEmail') // TODO Replace with actual custom server logic
          .then(deleteEmail)
          .done(reply, reply)
