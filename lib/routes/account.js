  ...
  const routes = [
    {
      ...
      handler: async function accountCreate(request, reply) {
    ...
    },
    {
      ...
      handler: async function accountKeys(request, reply) {
    ...
    },
    {
      ...
      handler: async function accountReset(request, reply) {
    ...
    },
    {
      ...
      handler: async function accountDestroy(request, reply) {
