...
module.exports = function (
  ...
  const oauthRoutes = require('../oauth/routing').routes;
  ...
  oauthRoutes.forEach(r => { r.path = basePath + '/v1/oauth' + r.path })

  const allRoutes = defaults.concat(idp, v1Routes, oauthRoutes)
