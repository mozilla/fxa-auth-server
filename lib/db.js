...
module.exports = function (
  ...
  DB.prototype.verifyToken = function (tokenVerificationId, accountData) {
    log.trace({ op: 'DB.verifyToken', tokenVerificationId: tokenVerificationId })
    return this.pool.post('/token/' + tokenVerificationId.toString('hex') + '/verify',
        unbuffer(
          accountData,
          'inplace'
        )
