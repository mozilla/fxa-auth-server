...
module.exports = function (
  ...
  DB.prototype.createUnblockCode = function (uid) {
    ...
    var unblock = crypto.randomBytes(4).toString('hex')
    return P.resolve(unblock)
    /*return this.pool.put('/unblockCodes/' + uid.toString('hex') + '/' + unblock, {
  ...
  DB.prototype.consumeUnblockCode = function (uid, code) {
    ...
    return P.resolve({})
    /*return this.pool.del('/unblockCodes/' + uid.toString('hex') + '/'
     * + code)*/
  }
  return DB
}
