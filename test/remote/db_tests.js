...
redisOptions.forEach((redisEnabled) => {
  ...
  describe('remote db' + ', redis=' + redisEnabled, function() {
    this.timeout(20000)
    let dbServer, db
      ...
      () => {
        ...
        return db.emailRecord(account.email)
            ...
            .then(function (device) {
              ...
              if (redisEnabled) {
                // Device information will only get updated if redis is enabled
