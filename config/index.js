...
conf.get('oauth.serviceClients').forEach(function(client) {
...
if (conf.get('oauth.openid.keyFile')){
  conf.set('oauth.openid.key', require(conf.get('oauth.openid.keyFile')));
}

if (conf.get('oauth.openid.oldKeyFile')){
  conf.set('oauth.openid.oldKey', require(conf.get('oauth.openid.oldKeyFile')));
}
//
// var key = conf.get('oauth.openid.key');
...
//
// var oldKey = conf.get('oauth.openid.oldKey');
