<a name="1.61.1"></a>
## [1.61.1](https://github.com/mozilla/fxa-auth-server/compare/v1.61.0...v1.61.1) (2016-05-04)


### Bug Fixes

* **tokens:** Send invalid-content-token metrics to datadog for monitoring ([4d07f9e](https://github.com/mozilla/fxa-auth-server/commit/4d07f9e))
